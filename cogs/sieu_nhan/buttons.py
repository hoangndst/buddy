...
class SuperheroButton(discord.ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        loading_view.add_item(
            ReturnToMenuButton(custom_id="return_to_menu_from_superhero_loading")
        )

        await interaction.response.edit_message(
            content=None, embed=loading_embed, view=loading_view
        )
        ...
        try:
            ...
            await interaction.followup.edit_message(
                interaction.message.id, content=None, embed=embed, view=view
            )
            ...
            error_view.add_item(
                ReturnToMenuButton(custom_id="return_to_menu_from_superhero_error")
            )
...
class GetAnotherHeroButton(discord.ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        try:
            ...
            error_view.add_item(
                ReturnToMenuButton(custom_id="return_to_menu_from_superhero_error2")
            )
